  ...
  return (
    <div className="text-white relative min-h-screen">
      ...
      <div className="relative overflow-hidden h-screen">
        ...
        {/* Hero content */}
        <motion.div
          className="relative flex flex-col justify-center items-start gap-10 px-20 h-full w-full"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          {/* Right Content */}
          <motion.div
            className="bg-[#ffffff24] text-[#fff] p-5 rounded-3xl backdrop-blur-sm border"
          ...
          >
            <div className="flex items-end gap-5 mb-5">
              ...
              <motion.div
                className="h-auto w-[300px] bg-[#fff] p-2 rounded-xl"
                variants={fadeInVariant}
              >
                <img
                  src={vtask}
            ...
            <motion.div className="max-w-[900px]" variants={fadeInVariant}>
      ...
      <section className="relative py-16">
        <div className="container mx-auto px-6 max-w-[1400px]">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl font-bold mb-12 text-center textGradient4"
          >
            Core Features
          </motion.h2>

          {/* Features Grid */}
          <div className="flex justify-center items-center gap-10 mb-10 flex-col md:flex-row">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="p-6 rounded-xl border border-white hover:border-[#F99F2C]/50 textGradient6 transition-colors duration-300 shadow-lg"
                >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-full h-[400px] overflow-hidden rounded-3xl bg-gray-800"
            >
              <img src={pharmacy2} alt="" />
            </motion.div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-10">
            ...
            <div className="w-full">
              <motion.div
                ...
                transition={{ duration: 0.6, ease: "easeOut" }}
                viewport={{ once: true }}
                className="rounded-2xl textGradient6 overflow-hidden shadow-xl h-full w-full p-6"
              >
                <h3 className="text-2xl textGradient6 font-bold mb-6 text-start text-[#F99F2C]">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7, ease: "easeOut" }}
          viewport={{ once: true }}
          className="text-center py-8 pt-20"
        >
