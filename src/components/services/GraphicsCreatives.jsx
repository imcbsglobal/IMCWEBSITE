      ...
      <section className="w-full max-w-[1400px] mb-20 mx-auto rounded-3xl bg-[#000] h-[600px] pt-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6">
          <div className="flex flex-col gap-6 justify-center">
            <h2 className="text-[50px] font-semibold text-gray-800 textGradient4">
            ...
            <ul className="space-y-4">
              <li className="flex items-centerw-full bg-gradient-to-r from-[#8d8d8d] via-[#ffffff] to-[#ffdd9e] overflow-hidden p-[1px] bg-[#3c3333] rounded-3xl">
                <div className="w-full h-full bg-[#000] rounded-3xl p-3 flex items-center">
                  {/* Left Icon Section */}
              ...
              <ul className="mt-4 space-y-4">
                <li className="flex justify-between items-center">
                  <div className="flex items-center gap-4 textGradient4 ">
                    <div className=" w-16 h-16 rounded-xl"><img src={visual} alt="visual" className="w-full h-full object-contain"/></div>
                    <span className="text-white ">Tailored Visual Solutions</span>
                  </div>
                  <span className="text-white text-center">Personalized designs for brand alignment</span>
                </li>
                <li className="flex justify-between items-center">
                  <div className="flex items-center gap-4 textGradient4">
                    <div className=" w-16 h-16 rounded-xl"><img src={idea} alt="idea" className="w-full h-full object-contain"/></div>
                    <span className="text-white ">Creative Excellence and Innovation</span>
                  </div>
                  <span className="text-white text-center">Expert designers using innovative strategies.</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="bg-black w-full h-full p-8 rounded-3xl shadow-md">
    ...
    <div className="flex justify-between mt-6">
      <div>
        ...
        <h4 className="text-xl font-bold text-white">20,000 Interactions</h4>
      </div>
      <div>
        <p className="text-sm text-white">Current Year Engagement</p>
        <h4 className="text-xl font-bold text-white">35,000 Interactions</h4>
