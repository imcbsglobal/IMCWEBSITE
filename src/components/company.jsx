  ...
  return (
    <>
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full -z-10">
        ...
        <div className="flex flex-col justify-center items-center w-full">
          ...
          >
            ...
            <div className="w-full px-2 max-w-[1400px] mx-auto">
              ...
              <motion.div
                className="text-[#fff] max-w-[700px] mb-10 mx-auto px-2 textGradient6 text-center overflow-hidden"
                style={{
        ...
        {/* TEAM */}
        <div
          className="pt-[50px] py-20 relative flex flex-col justify-center items-center w-full"
          ref={sectionRef2}
        >
          ...
          <section className="w-full max-w-[1400px] mx-auto" id="team">
            ...
            <div className="mb-10 text-center ">
              <motion.div
                className="text-[#fff] textGradient4 text-[30px] md:text-[50px] leading-tight mb-5"
                style={{
        ...
        {/* goalsmission */}
        <div className="pt-[50px] relative flex flex-col justify-center items-center w-full">
          ...
          >
            ...
            <motion.div
              className="text-[#fff] max-w-[900px] mx-auto text-center textGradient6 text-sm sm:text-base"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="w-full flex flex-col gap-5">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="bg-[#ffffff11] backdrop-blur-sm border text-[#fff] h-auto p-4 rounded-3xl">
        ...
        {/* SUPPORTS */}
        <div
          className="pt-2 relative py-20 flex flex-col justify-center items-center w-full"
          ref={sectionRef3}
        >
          {/* <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full -z-10">
            <motion.img
            ...
            <div className="h-auto w-full overflow-hidden rounded-3xl">
              <div className="rounded-3xl w-full h-full overflow-hidden p-4">
                <div className="text-center mb-8">
                  <motion.h2
                    ref={headingRef}
                    className="text-[30px] sm:text-[40px] md:text-[50px] font-extrabold text-gray-800 mb-1 textGradient4 pt-5"
