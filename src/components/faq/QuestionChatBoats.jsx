      ...
      <section className="w-full max-w-[1400px] mx-auto flex flex-col justify-center items-center h-screen mb-20 mt-[-20px] md:mt-[10px] px-4">
        <div>
          ...
          <div className="text-center text-[#fff] max-w-[1000px] mx-auto mb-6 text-sm md:text-base">
            Need answers fast? Our AI-powered question-based chatbot is here to
            help. Whether it's customers, employees, or students seeking
            information, the chatbot delivers accurate and instant answers 24/7.
            From product inquiries and FAQs to complex problem-solving, your
            virtual assistant has it covered.
          </div>
          ...
          <div className="w-full flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5">
            <button className="px-8 py-3 rounded-full bg-[#fff] font-semibold flex items-center gap-2 text-sm md:text-base">
              Get Started{" "}
              <span>
                <FaArrowRightLong />
              </span>
