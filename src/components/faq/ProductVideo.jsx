        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-[#000] max-w-3xl mx-auto ">
              Stay tuned with our latest vlogs, news, and feature highlights.
              Catch behind-the-scenes moments, product spotlights, and updates
              that keep you informed and inspired.
            </p>
          </div>
