        ...
        <section className="relative py-10">
          <div className="max-w-[1400px] mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
              className="md:flex gap-10 justify-center items-center"
            >
              {/* Animated Image */}
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:w-[50%] h-[400px] overflow-hidden rounded-3xl mb-6 md:mb-0"
              >
                <img
              ...
              >
                ...
                <div className="text-[#fff] textGradient6 mb-5">
                  At IMC Business Solutions, we offer a supportive and
                  innovative workplace where your skills and ideas matter.
                  Whether you're experienced or just starting, we help you grow
                  and succeed.
                </div>
                ...
                <motion.ul
                  ...
                  className="flex flex-col gap-3 textGradient6"
                >
                  {[
                    {
                      title: "Career Growth",
                      desc: "Training, mentorship, and opportunities to advance.",
                    },
                    {
                      title: "Work-Life Balance",
                      desc: "A flexible and supportive environment.",
                    },
                    {
                      title: "Exciting Projects",
                      desc: "Work on cutting-edge IT solutions.",
                    },
                    {
                      title: "Great Team",
                    ...
                    <motion.li
                      ...
                      className="bg-[#ffffff22] px-4 py-3 rounded-lg text-[#fff]"
                    >
        ...
        <section className="w-full flex justify-center px-4">
          <div className="max-w-[1400px] w-full">
            ...
            <motion.h2
              ...
              transition={{ duration: 0.8, ease: "easeOut" }}
              viewport={{ once: true }}
              className="text-3xl font-bold text-[#fff] mb-8 text-center textGradient4"
            >
              Open Positions
            </motion.h2>
            ...
            {loading ? (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                transition={{ duration: 0.5 }}
                className="text-center text-[#fff] p-10"
              >
                ...
                {careers.map((career, index) => (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => {
                        const positionTitle = encodeURIComponent(career.title);
